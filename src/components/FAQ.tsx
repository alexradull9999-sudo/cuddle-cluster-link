...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "В заявке укажите количество людей, тип сценария и размеры помещения. Инженер пришлет варианты с расчетом размещения. При желании — выезд на замер."
  },
  {
  ...
  },
  {
    ...
    answer: "Стандартные модели — от 14 дней. Кастомные проекты — от 30 дней."
  },
  {
  ...
  },
  {
    ...
    answer: "В шоуруме Санкт-Петербург, ул. Бехтерева, 3к2. Запись по предварительной договоренности. Если далеко — проведем видео-демонстрацию."
  },
  {
    question: "Как получить коммерческое предложение?",
    answer: "Оставьте заявку. После короткого разговора с инженером пришлем расчет под ваше помещение и сценарий: модель, конфигурацию, сроки, цену, условия монтажа."
  }
];
