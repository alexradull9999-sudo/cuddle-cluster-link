...
const STATS_ITEMS = [
  ...
  {
    value: "до 35 дБ",
    label: "шумоподавление в серийных моделях"
  },
  {
    value: "1000+",
...
const STEPS: ProductionStep[] = [
  {
    ...
    description: "Менеджеры подбирают состав звукоизоляционного сэндвича под конкретный шум и сценарий, а не по каталогу."
  },
  {
    id: "step-2",
    number: "02",
  ...
  },
  {
    ...
    description: "Упаковываем, отгружаем, собираем на месте. Сопровождаем до подписания акта."
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="mt-4 text-sm sm:text-base text-zinc-500 max-w-xl font-normal leading-relaxed">
            Над проектами работают опытные менеджеры и дизайнеры в собственном конструкторском бюро
          </p>
        </div>
